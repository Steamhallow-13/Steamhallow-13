...
/obj/item/clothing/under/color/random/Initialize(mapload)
	...
	if(ishuman(loc))
		...
		H.equip_to_slot_or_del(new C(H), ITEM_SLOT_I_TORSOWEAR, initial=TRUE) //or else you end up with naked assistants running around everywhere...
	else
		new C(loc)
...
/obj/item/clothing/under/color/jumpskirt/random/Initialize(mapload)
	...
	if(ishuman(loc))
		var/mob/living/carbon/human/H = loc
		H.equip_to_slot_or_del(new C(H), ITEM_SLOT_I_TORSOWEAR, initial=TRUE)
	else
		new C(loc)
	return INITIALIZE_HINT_QDEL
