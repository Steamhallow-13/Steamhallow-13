...
/datum/admins/Topic(href, href_list)
	...
	if(href_list["editrightsbrowsermanage"])
		...
		if(ishuman(L))
			...
			observer.equip_to_slot_or_del(new /obj/item/clothing/under/costume/buttondown/slacks/service(observer), ITEM_SLOT_I_TORSOWEAR)
			observer.equip_to_slot_or_del(new /obj/item/clothing/inner_neck/tie/black/tied(observer), ITEM_SLOT_I_NECK)
