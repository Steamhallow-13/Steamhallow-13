...
/obj/item/mod/module/clamp
	...
	required_slots = list(ITEM_SLOT_L_HAND|ITEM_SLOT_R_HAND, ITEM_SLOT_BACK)
...
/obj/item/mod/module/sphere_transform
	...
	required_slots = list(ITEM_SLOT_O_TORSOWEAR|ITEM_SLOT_I_TORSOWEAR, ITEM_SLOT_HEAD|ITEM_SLOT_MASK)
