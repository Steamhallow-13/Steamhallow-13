/datum/outfit/ctf/medisim
	...
	nodrop_slots = list(ITEM_SLOT_O_TORSOWEAR, ITEM_SLOT_L_HAND, ITEM_SLOT_R_HAND, ITEM_SLOT_FEET, ITEM_SLOT_I_TORSOWEAR, ITEM_SLOT_EARS, ITEM_SLOT_BELT, ITEM_SLOT_HEAD)
