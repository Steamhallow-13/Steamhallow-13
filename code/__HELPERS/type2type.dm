...
/proc/slot2body_zone(slot)
	switch(slot)
		if(ITEM_SLOT_BACK, ITEM_SLOT_O_TORSOWEAR, ITEM_SLOT_I_TORSOWEAR, ITEM_SLOT_BELT, ITEM_SLOT_CHEST)
			return BODY_ZONE_CHEST

		if(ITEM_SLOT_GROIN, ITEM_SLOT_VAGINA, ITEM_SLOT_DICK, ITEM_SLOT_ANUS, ITEM_SLOT_TAIL, ITEM_SLOT_L_HIP, ITEM_SLOT_R_HIP)
			return BODY_ZONE_PRECISE_GROIN

		if(ITEM_SLOT_HANDS, ITEM_SLOT_HANDCUFFED)
			return pick(BODY_ZONE_PRECISE_L_HAND, BODY_ZONE_PRECISE_R_HAND)

		if(ITEM_SLOT_L_HAND, ITEM_SLOT_L_HAND_THUMB, ITEM_SLOT_L_HAND_INDEX, ITEM_SLOT_L_HAND_MIDDLE, ITEM_SLOT_L_HAND_RING, ITEM_SLOT_L_HAND_PINKY)
			return BODY_ZONE_PRECISE_L_HAND

		if(ITEM_SLOT_R_HAND, ITEM_SLOT_R_HAND_THUMB, ITEM_SLOT_R_HAND_INDEX, ITEM_SLOT_R_HAND_MIDDLE, ITEM_SLOT_R_HAND_RING, ITEM_SLOT_R_HAND_PINKY)
			return BODY_ZONE_PRECISE_R_HAND

		if(ITEM_SLOT_HEAD, ITEM_SLOT_I_NECK, ITEM_SLOT_O_NECK, ITEM_SLOT_EARS, ITEM_SLOT_EARS_LEFT, ITEM_SLOT_EARS_RIGHT)
			return BODY_ZONE_HEAD

		if(ITEM_SLOT_MASK, ITEM_SLOT_MAW)
		...
		if(ITEM_SLOT_LEGCUFFED, ITEM_SLOT_I_LEGWEAR, ITEM_SLOT_O_LEGWEAR)
